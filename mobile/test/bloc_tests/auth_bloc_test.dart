...
void main() {
  ...
  group('AuthenticationBloc', () {
    ...
    test('should emit AuthenticationLoading and AuthenticationStateUserAuthenticated when LoginEvent is added and login is successful', () {
      // Arrange
      ...
      when(mockAuthenticationRepository.login(signInForm: signInForm)).thenAnswer((_) async => Right(userData));
    ...
    test('should emit AuthenticationLoading and AuthenticationStateError when LoginEvent is added and login fails', () {
      // Arrange
      final signInForm = SignInForm(
        email: 'test@example.com',
        password: 'password123',
      ...
      when(mockAuthenticationRepository.login(signInForm: signInForm)).thenAnswer((_) async => Left(failure));
